...
export const ROLE_TYPES: Record<string, string[]> = {
  ...
  notes: ["rich_text"],
  views: ["number", "rollup", "formula"],
  opens: ["number", "rollup", "formula"],
  clicks: ["number", "rollup", "formula"],
...
const ROLE_HINTS: Record<string, string[]> = {
  ...
  views: ["views", "viewcount", "plays", "watches", "impressions", "reach"],
  opens: ["opens", "opencount", "openrate", "recipients", "delivered", "subscribers"],
  clicks: ["clicks", "clickcount", "clickthrough", "ctr", "linkclicks"],
